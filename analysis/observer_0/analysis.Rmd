...
Now, we quantify the observed results in the previous plot by computing a linear mixed-effects regression (predicting individual participant judgments as a function of enforcer action and condition).
...
model_3 = lmer(formula=reward ~ enforcer_action*condition + 
               (1+condition|workerid), data=data_16)
summary(model_3)
