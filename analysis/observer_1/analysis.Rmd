---
title: "Physical Pragmatics (observer_1)"
output:
...
human_path = "data/observer_1/human/data_0"

# Set up the path to the model data.
model_path = "data/observer_1/model"
```
...
Here we plot mean participant judgments ($N$=`r nrow(age)`, $M$=`r round(mean(age$age, na.rm=TRUE), 2)` years, $SD$=`r round(sd(age$age, na.rm=TRUE), 2)` years) against our model's predictions in both conditions jointly (a replication of `observer_0`).
