...
# Load data.
#trials_1 = read.csv("data/observer_1/human/pilot_1/observer_1-trials.csv")
#trials_2 = read.csv("data/observer_1/human/pilot_2/observer_1-trials.csv")
#trials_3 = read.csv("data/observer_1/human/pilot_3/observer_1-trials.csv")
#trials_4 = read.csv("data/observer_1/human/pilot_4/observer_1-trials.csv")
#trials_5 = read.csv("data/observer_1/human/pilot_5/observer_1-trials.csv")
#trials_6 = read.csv("data/observer_1/human/pilot_6/observer_1-trials.csv")
#trials_7 = read.csv("data/observer_1/human/pilot_7/observer_1-trials.csv")
#trials_8 = read.csv("data/observer_1/human/pilot_8/observer_1-trials.csv")
trials_9 = read.csv("data/observer_1/human/pilot_9/observer_1-trials.csv")
total_trials = list(trials_9)
...
for (trials in total_trials) {
  ...
  for (i in 1:nrow(trials)) {
    ...
    filepath = paste("data/observer_1/model/01234/", filename, ".txt", sep="")
