---
title: "Physical Pragmatics (decider_1)"
output:
...
data_0_path = "data/decider_1/data_0"
data_1_path = "data/decider_1/data_1"
data_2_path = "data/decider_1/data_2"
```
...
# Set the seed and compute the 95% bootstrapped CI.
set.seed(seed)
bootstrap_data = compute_bootstrap(data_11)
lower_ci = bootstrap_data[4] * 100
upper_ci = bootstrap_data[5] * 100
...
data_12 = data_11 %>%
  group_by(target) %>%
  summarize(percentage=n()/nrow(data_11)*100) %>%
  mutate(target=as.character(target))
