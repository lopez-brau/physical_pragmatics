...
# Define the ratio between the cost the enforcer pays to act versus the cost the enforcer incurs on the actor.
COST_RATIO = 1.0
...
# Determine if we're using an exhaustive or sampling approach. If we're using sampling, set the max number of samples 
