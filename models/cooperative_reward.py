...
def cooperative_reward(enforcer_rewards, reward_probabilities, method,
        cooperation):
    ...
    if method == "confidence":
        ...
        for enforcer_reward in enforcer_rewards:
            enforcer_preference = \
                (max(enforcer_reward) == enforcer_reward) + 0.0
            ...
            inferred_enforcer_reward = inferred_enforcer_reward \
                + (reward_probabilities[tuple(enforcer_reward)] \
                    * enforcer_preference)
    ...
    # infers that the max of those rewards is the enforcer's preference.
        ...
        for enforcer_reward in enforcer_rewards:
            expected_enforcer_rewards = expected_enforcer_rewards \
                + enforcer_reward \
                * reward_probabilities[tuple(enforcer_reward)]
        expected_enforcer_preference = \
            (max(expected_enforcer_rewards) == expected_enforcer_rewards) \
            + 0.0
