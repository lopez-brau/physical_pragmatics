...
<body>
	<div class="slide" style="display:grid;grid-template-rows:1fr;grid-template-columns:1fr;position:relative;align-items:center;">
		<h3><p style="grid-row:1;grid-column:1;">To receive credit for completing this experiment and return back to Prolific, please click <a href="https://app.prolific.co/submissions/complete?cc=459F6C2E">here</a>.</p><h3>
	</div>
</body>
</html>
