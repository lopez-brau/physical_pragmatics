...
if (isset($_SESSION["pid"])) {
  ...
  $experiment_dir = "/var/www/html/studies/lopez-brau/physical_pragmatics/experiments/decider_2/";
...
<head>
  ...
  <!-- Experiment files. -->
  <script src="js/decider_2.js"></script>

  <!-- Experiment specific helper functions. -->
  <script src="js/decider_2_utils.js"></script>
</head>
...
<body onload="init();">
  ...
  <div class="slide" id="i0">
    ...
    <div id="instruct-text">
      <p>In this experiment, you will be presented with a story and asked to describe some scenes. The experiment should take about <span class="time"></span> minutes. Please read carefully, thanks!</p>
    </div>
    <div id="legal">
  ...
  <div class="slide" id="background_0">
    <h3>Background</h3>
    <p>Imagine you work in an office with two identical exits. One day, as you're leaving, you notice something near one of the exits.</p>
  ...
  <div class="slide" id="instructions_0">
    <h3>Background</h3>
    <p>On each trial, you will see a door with something near it and will have to answer how unusual it is that someone placed that there (using a slider bar ranging from "not at all" to "very unusual"). There will be two trials in total. Press 'Continue' to begin.</p>
    <button onclick="_s.button()">Continue</button>
  </div>
