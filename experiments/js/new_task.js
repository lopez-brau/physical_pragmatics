...
function make_slides(f) {
        ...
        button: function() {
            ...
            if ((exp.target_0 == undefined) || (exp.target_1 == undefined) || 
                ...
                exp.catch_trials.push({
                    ...
                    "agent_coords": exp.trials[0].slice(0, 5),
                    "pear_coords": exp.trials[0].slice(6, 11),
    ...
    slides.catch_trial_extra = slide({
        ...
        start: function() {
            ...
            exp.sentence_5 = "For any hiker, which scenario are they more likely to detect that " + exp.enforcer.name + 
                             " placed the boulders?";
            ...
            $(".display_catch_options").html("<p>Hikers' ability to detect whether " + exp.enforcer.name + " placed the boulders " +
                                             ...
                                             "<p>" + exp.sentence_5 + "</p>" +
                                             "<div align=\"center\">" +
                                             "<img style=\"margin-right:20px;height:200px;width:auto;\" src=\"../stimuli/observer_0/boulder_independence_1.png\"></img>" +
                                             "<img style=\"margin-left:20px;height:200px;width:auto;\" src=\"../stimuli/observer_0/boulder_independence_2.png\"></img>" +
                                             "</div>" +
                                             "<p>" +
    ...
    function start() {
        ...
        $(".display_setup").html("Consider the following scenario with a <b>new</b> hiker.");
    ...
    slides.logic_1 = slide({
        ...
        start: function() {
            ...
            $(".display_stimulus").html("<img style=\"height:280px;width:auto;\" src=\"../stimuli/observer_0/" + 
                                        exp.trials[0].slice(0, 5) + "/" + exp.trials[0].slice(6, 11) +
                                        "/[3 4]_[1 0].png" + "\"></img>");
...
function init() {
    ...
    exp.time = 10;
    $(".display_time").html(exp.time);
    $(".display_payment").html("$" + (exp.time*6/60).toPrecision(3));
    repeatWorker = false;
    (function() {
        var ut_id = "malb_social_pragmatics_02-04-2018_observer_0";
    ...
    exp.structure = ["i0", "background_1", "background_2", "background_3", "background_4", "background_5", "background_6",
                     "background_7", "background_8", "instructions_1", "instructions_2", "catch_trial"];
